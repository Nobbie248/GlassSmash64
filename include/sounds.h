...
#define SOUND_ACTION_THROW                       /* 0x04358081 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x35, 0x90, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_GENERAL_BREAK_BOX                  /* 0x3041C081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x41, 0x80, SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_RACE_GUN_SHOT              /* 0x314D4081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x4D, 0x80, SOUND_NO_VOLUME_LOSS | SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_YOSHI_TALK                 /* 0x30703081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x70, 0x80, SOUND_DISCRETE) // unverified
...
#define SOUND_GENERAL_BOAT_ROCK                  /* 0x30750081 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x75, 0x80, SOUND_DISCRETE) // unverified
...
#define SOUND_OBJ_UKIKI_CHATTER_LONG             /* 0x50210081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x21, 0x80, SOUND_DISCRETE)
...
#define SOUND_OBJ_SNUFIT_SHOOT                   /* 0x504D0081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x4D, 0x80, SOUND_DISCRETE)
...
#define SOUND_OBJ_MAD_PIANO_CHOMPING             /* 0x52564081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ,      0x56, 0x80, SOUND_VIBRATO | SOUND_DISCRETE)
...
#define SOUND_AIR_BOWSER_SPIT_FIRE               /* 0x60000001 */ SOUND_ARG_LOAD(SOUND_BANK_AIR,      0x00, 0x80, SOUND_DISCRETE)
...
#define SOUND_OBJ2_PIRANHA_PLANT_DYING           /* 0x90116081 */ SOUND_ARG_LOAD(SOUND_BANK_OBJ2,     0x11, 0x80, SOUND_DISCRETE)

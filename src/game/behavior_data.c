...
extern void bhv_hidden_object_init();
...
extern void bhv_static_object_on_console_loop();
const BehaviorScript bhvStaticObjectOnConsole[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_static_object_on_console_loop),
    END_LOOP(),
};
...
const BehaviorScript bhvBrick[] = {
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(bhv_brick_loop),
    END_LOOP(),
};

const BehaviorScript bhvBrick2[] = {
    BEGIN(OBJ_LIST_DESTRUCTIVE),
    OR_INT(oFlags, (OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ -400, /*Bounciness*/ -70, /*Drag strength*/ 2500, /*Friction*/ 5000, /*Buoyancy*/ 300, /*Unused*/ 0, 0),
...
const BehaviorScript bhvAztecPots[] = {
    ...
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 150, /*Height*/ 310, /*Downwards offset*/ 50),
    CALL_NATIVE(bhv_pots_init),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),

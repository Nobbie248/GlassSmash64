...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		MARIO_POS(0x01, 0, 12, 34, -6418),
		OBJECT(0, 12, 34, -6418, 0, 0, 0, 0xa0000, bhvSpinAirborneWarp),
		...
		OBJECT(MODEL_NONE, 2093, 1052, -958, 0, 0, 0, 0x00000000, bhvAztecPots),

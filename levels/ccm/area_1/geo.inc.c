...
const GeoLayout ccm_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, -3687, 585, 5125),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, -1016, 796, 3896),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_001_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, -3014, 735, 3235),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_002_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, 2018, 730, 5205),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_003_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, 4218, 722, 2446),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_004_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, 3253, 410, 278),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_005_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, 3628, 651, -827),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_006_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, -1821, 585, -1402),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_007_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_BILLBOARD_WITH_PARAMS(LAYER_OPAQUE, -151, 858, 321),
			GEO_OPEN_NODE(),
				GEO_CULL(-32000, -32000, -32000, -32000, -32000, -32000, 0),
				GEO_OPEN_NODE(),
					GEO_DISPLAY_LIST(LAYER_TRANSPARENT, ccm_dl_light_beam_008_mesh_layer_5),
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),

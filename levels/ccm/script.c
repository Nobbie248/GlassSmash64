...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_KITE, -988, 1440, 5420, 0, 84, 0, 0x00000000, bhvBallsaver),
		OBJECT(MODEL_KITE, -3256, 1440, 4484, 0, -52, 0, 0x00000000, bhvBallsaver),
		OBJECT(MODEL_KITE, 936, 1382, 6037, 0, -84, 0, 0x00000000, bhvBallsaver),
		OBJECT(MODEL_KITE, 2588, 1382, 5559, 0, 118, 0, 0x00000000, bhvBallsaver),

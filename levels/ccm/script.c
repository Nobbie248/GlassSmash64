...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_BARREL, -761, 1004, 2105, 0, -180, 0, 0x00000000, bhvBarrel),
		OBJECT(MODEL_BARREL, 164, 536, 4796, 0, -180, 0, 0x00000000, bhvBarrel),
		OBJECT(MODEL_BARREL, 2346, 540, 4796, 0, -180, 0, 0x00000000, bhvBarrel),
		OBJECT(MODEL_BARREL, 2639, 466, 4796, 0, -120, 93, 0x00000000, bhvBarrel),
		OBJECT(MODEL_BARREL, -2894, 454, 1128, 0, -180, 0, 0x00000000, bhvBarrel),
		OBJECT(MODEL_BARREL, 951, 622, 378, 0, -180, 0, 0x00000000, bhvBarrel),
		...
		OBJECT(MODEL_CHEST, -629, 2041, 1393, 0, -180, 0, 0x00000000, bhvChest),
		OBJECT(MODEL_DIAMOND, -2120, 1142, 1269, 0, 0, 0, 0x00000000, bhvDiamond),
		OBJECT(MODEL_KITE, -988, 2565, 5420, 0, 84, 0, 0x00000000, bhvKite),
		OBJECT(MODEL_KITE, -3256, 2565, 4484, 0, -52, 0, 0x00000000, bhvKite),
		OBJECT(MODEL_KITE, 936, 2507, 6037, 0, -84, 0, 0x00000000, bhvKite),
		OBJECT(MODEL_KITE, 2588, 2507, 5559, 0, 118, 0, 0x00000000, bhvKite),
		OBJECT(MODEL_KITE, 2588, 1283, -1344, 0, 53, 0, 0x00000000, bhvKite),
		...
		OBJECT(MODEL_SAVER, 1570, 165, 9639, 90, 0, 90, 0x00000000, bhvBallsaver),

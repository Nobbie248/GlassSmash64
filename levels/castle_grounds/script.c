...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(0, 0, 2110, 0, 0, 90, 0, 0x200000, bhvAirborneDeathWarp),
		OBJECT(0, 0, 2110, 0, 0, 49, 0, 0x50000, bhvAirborneStarCollectWarp),
		OBJECT(0, 0, 2110, 0, 0, -55, 0, 0x30000, bhvAirborneStarCollectWarp),
		OBJECT(0, 0, 2110, 0, 0, -90, 0, 0x70000, bhvAirborneStarCollectWarp),
		OBJECT(0, 0, 2110, 0, 0, 90, 0, 0x1f0000, bhvAirborneStarCollectWarp),

...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(0, -2, 59, 3822, 0, 0, 0, 0x60000, bhvAirborneDeathWarp),
		OBJECT(0, -2, 59, 3822, 0, 0, 0, 0x40000, bhvAirborneDeathWarp),
		OBJECT(0, -2, 59, 3822, 0, 0, 0, 0x80000, bhvAirborneDeathWarp),
		OBJECT(0, -2, 59, 3822, 0, 0, 0, 0x200000, bhvAirborneDeathWarp),

...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(0, 2830, 59, 475, 0, 0, 0, 0x60000, bhvAirborneDeathWarp),
		OBJECT(0, 2830, 59, 475, 0, 0, 0, 0x40000, bhvAirborneDeathWarp),
		OBJECT(0, 2830, 59, 475, 0, 0, 0, 0x80000, bhvAirborneDeathWarp),
		OBJECT(0, 2830, 59, 475, 0, 0, 0, 0x200000, bhvAirborneDeathWarp),
		...
		OBJECT(MODEL_CAR, 2738, 0, 541, 0, 0, 0, 0x00000000, bhvCar),

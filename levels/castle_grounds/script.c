...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_BRICK, -1203, 200, -735, 0, 0, 0, 0x0, bhvBrick),
		OBJECT(0, 2950, 200, -1638, 0, 48, 0, 0x60000, bhvAirborneDeathWarp),
		OBJECT(0, -1117, 200, -1385, 0, -55, 0, 0x40000, bhvAirborneDeathWarp),
		OBJECT(0, -1195, 200, -3770, 0, -90, 0, 0x80000, bhvAirborneDeathWarp),
		OBJECT(0, 3512, 200, -3788, 0, 90, 0, 0x200000, bhvAirborneDeathWarp),
		OBJECT(0, 2946, 200, -1642, 0, 49, 0, 0x50000, bhvAirborneStarCollectWarp),
		OBJECT(0, -1116, 200, -1389, 0, -55, 0, 0x30000, bhvAirborneStarCollectWarp),
		OBJECT(0, -1198, 200, -3765, 0, -90, 0, 0x70000, bhvAirborneStarCollectWarp),
		OBJECT(0, 3511, 200, -3790, 0, 90, 0, 0x1f0000, bhvAirborneStarCollectWarp),
		OBJECT(0, 1049, 200, -506, 0, -180, 0, 0x250000, bhvDeathWarp),
		OBJECT(0, 1044, 200, -5127, 0, -180, 0, 0x260000, bhvDeathWarp),
		OBJECT(0, 1047, 1145, -1048, 0, 0, 0, 0x2c1e00, bhvFadingWarp),
		MARIO_POS(0x01, 0, 1071, 1145, -805),
		OBJECT(0, 1052, 1145, -500, 0, -180, 0, 0xa0000, bhvSpinAirborneWarp),
		OBJECT(0, -2032, 3120, -604, 0, 136, 0, 0xe0000, bhvWarp),
		OBJECT(0, 3651, 3060, -1053, 0, -39, 0, 0x100000, bhvWarp),
		OBJECT(0, -1834, 2745, -3815, 0, 0, 0, 0x110000, bhvWarp),
		OBJECT(0, 3874, 2355, -3791, 0, -90, 0, 0xd0000, bhvWarp),
		OBJECT(0, 1040, 3875, -5648, 0, 0, 0, 0x120000, bhvWarp),
		OBJECT(0, 1037, 2355, -4041, 0, 136, 0, (22 << 16), bhvDeathWarp),

...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_THI_WARP_PIPE, -953, 0, 2372, 0, 136, 0, 0xe0000, bhvWarpPipe),
		...
		OBJECT(MODEL_TARGETS, 1201, 325, 74, 0, 0, 90, 0, bhvTarget),
		OBJECT(MODEL_TARGETS, 1201, 325, 908, 0, 0, 90, 0, bhvTarget),
		OBJECT(MODEL_TARGETS, -1211, 645, 908, 0, 0, 0, 0, bhvTarget),
		OBJECT(MODEL_TARGETS, -1211, 130, 79, 0, 0, 0, 0, bhvTarget),
		OBJECT(MODEL_TOAD, 0, 0, -1183, 0, 0, 0, 0x52000000, bhvToadMessage),

...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_TOAD, 200, 0, -1220, 0, 136, 0, 0x52000000, bhvToadMessage),
		...
		OBJECT(MODEL_TARGETS, 0, 744, -1446, 90, 0, 0, 0x00000000, bhvTarget),
		OBJECT(MODEL_TARGETS, 1128, 903, -940, 90, 0, 0, 0x00000000, bhvTarget),
		OBJECT(MODEL_TARGETS, -964, 564, -940, 90, 0, 0, 0x00000000, bhvTarget),
		OBJECT(MODEL_TARGETS, -964, 711, 634, -180, 0, 0, 0x00000000, bhvTarget),
		OBJECT(MODEL_TARGETS, 1128, 1240, 634, -180, 0, 0, 0x00000000, bhvTarget),
		OBJECT(MODEL_TARGETS, 0, 1029, 1198, -180, 0, 0, 0x00000000, bhvTarget),
		OBJECT(MODEL_TARGETS, -931, 402, -86, -180, 0, 0, 0x00000000, bhvTarget),
		OBJECT(MODEL_TARGETS, 1298, 1240, 0, -180, 0, 0, 0x00000000, bhvTarget),

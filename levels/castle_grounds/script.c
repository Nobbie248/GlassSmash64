...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(MODEL_THI_WARP_PIPE, 1, 0, 2842, 0, 136, 0, 0xe0000, bhvWarpPipe),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 303, 0, 2850, 0, -180, 0, 0x320000, bhvMessagePanel),
		OBJECT(MODEL_TARGETS, 1201, 325, 1299, 0, 0, 90, 0, bhvTarget),
		OBJECT(MODEL_TARGETS, 1201, 325, 2486, 0, 0, 90, 0, bhvTarget),
		OBJECT(MODEL_TARGETS, -1211, 645, 2486, 0, 0, 0, 0, bhvTarget),
		OBJECT(MODEL_TARGETS, -1211, 130, 1304, 0, 0, 0, 0, bhvTarget),
		OBJECT(MODEL_TOAD, 0, 0, 3484, 0, 136, 0, 0x52000000, bhvToadMessage),

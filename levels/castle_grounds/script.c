...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(0, 2830, 59, 810, 0, 0, 0, 0x60000, bhvAirborneDeathWarp),
		OBJECT(0, 2830, 59, 810, 0, 0, 0, 0x40000, bhvAirborneDeathWarp),
		OBJECT(0, 2830, 59, 810, 0, 0, 0, 0x80000, bhvAirborneDeathWarp),
		OBJECT(0, 2830, 59, 810, 0, 0, 0, 0x200000, bhvAirborneDeathWarp),
		OBJECT(0, 0, 2110, 0, 0, 0, 0, 0x50000, bhvAirborneStarCollectWarp),
		OBJECT(0, 0, 2110, 0, 0, 0, 0, 0x30000, bhvAirborneStarCollectWarp),
		OBJECT(0, 0, 2110, 0, 0, 0, 0, 0x70000, bhvAirborneStarCollectWarp),
		OBJECT(0, 0, 2110, 0, 0, 0, 0, 0x1f0000, bhvAirborneStarCollectWarp),
		OBJECT(0, 0, 2110, 0, 0, 0, 0, 0x250000, bhvDeathWarp),
		OBJECT(0, 0, 2110, 0, 0, 0, 0, 0x260000, bhvDeathWarp),
		OBJECT(0, 0, 2493, 0, 0, 0, 0, 0x2c1e00, bhvFadingWarp),
		OBJECT(0, 0, 0, 0, 0, -180, 0, 0xa0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_PURPLE_PIPE, -953, 0, 2035, 0, 0, 0, 0xe0000, bhvWarpPipe),
		OBJECT(MODEL_PURPLE_PIPE, 956, 0, 4213, 0, 0, 0, 0x100000, bhvWarpPipe),
		...
		OBJECT(MODEL_PURPLE_PIPE, 952, 0, 8035, 0, -90, 0, 0xd0000, bhvWarpPipe),
		OBJECT(MODEL_NONE, 0, 124, -331, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_NONE, -953, 0, 2035, 0, 0, 0, 0x00000000, bhvHubtext1),
		OBJECT(MODEL_NONE, 956, 0, 4214, 0, 0, 0, 0x00000000, bhvHubtext2),
		OBJECT(MODEL_NONE, -952, 0, 6124, 0, 0, 0, 0x00000000, bhvHubtext3),
		OBJECT(MODEL_NONE, 951, 0, 8035, 0, 0, 0, 0x00000000, bhvHubtext4),

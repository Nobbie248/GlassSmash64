...
const LevelScript level_main_scripts_entry[] = {
    ...
    ALLOC_LEVEL_POOL(),
    LOAD_MODEL_FROM_GEO(MODEL_MARIO,                   mario_geo), // normal mario lol
    LOAD_MODEL_FROM_GEO(MODEL_D_MARIO,                 d_hammer_mario_geo),
    LOAD_MODEL_FROM_GEO(MODEL_H_MARIO,                 hammer_mario_geo), // hammer mario 
    LOAD_MODEL_FROM_GEO(MODEL_BOUNCE,                  bounce_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BLUE_MUSHROOM,           schoom_blue_geo),
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_VASE,                    vase_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BALL,                    ball_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BARREL,                  barrel_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BOTTLE,                  bottle_geo),
    LOAD_MODEL_FROM_GEO(MODEL_DIAMOND,                 diamond_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SAVER,                   saver_geo),
    LOAD_MODEL_FROM_GEO(MODEL_OOGABOOGA,               oogabooga_geo),
    LOAD_MODEL_FROM_GEO(MODEL_OOGABOOGA2,              oogabooga2_geo),
    LOAD_MODEL_FROM_GEO(MODEL_CHEST,                   chest_geo),
    LOAD_MODEL_FROM_GEO(MODEL_KITE,                    kite_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BALL_SAVER_PARTICLE,     ball_saver_particle_geo),
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MIXER,                   mixer_geo),
    LOAD_MODEL_FROM_GEO(MODEL_4DCUBE,                  _4dcube_geo),
    LOAD_MODEL_FROM_GEO(MODEL_KOOPY,                   koopy_geo),
    LOAD_MODEL_FROM_GEO(MODEL_YOSHY,                   yoshy_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TOADY,                   toady_geo),
    LOAD_MODEL_FROM_GEO(MODEL_BNET,                    bnet_geo),

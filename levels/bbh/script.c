...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_PLATFORM2D, -2025, 1813, 0, 0, 0, 0, 0x00000000, bhvPlatform2d),
		OBJECT(MODEL_PLATFORM2D, 1921, 3584, 0, 0, 0, 0, 0x00000000, bhvPlatform2d),
		OBJECT(MODEL_TARGET2, -326, 2597, 0, 0, 0, 90, 0x00000000, bhvTarget2side),
		OBJECT(MODEL_TARGET2, -1231, 2239, 0, 0, 0, 0, 0x00000000, bhvTarget2),
		OBJECT(MODEL_TARGET2, -1231, 2859, 0, 0, 0, 0, 0x00000000, bhvTarget2),
		OBJECT(MODEL_TARGET2, -326, 3241, 0, 0, 0, 90, 0x00000000, bhvTarget2side),
		OBJECT(MODEL_TARGET2, 942, 3309, 0, 0, 0, 90, 0x00000000, bhvTarget2side),
		OBJECT(MODEL_TARGET2, 941, 4387, 0, 0, 0, 0, 0x00000000, bhvTarget2),
		OBJECT(MODEL_TARGET2, 2940, 4139, 0, 0, 0, 90, 0x00000000, bhvTarget2side),
		OBJECT(MODEL_TARGET2, 1828, 2235, 0, 0, 0, 0, 0x00000000, bhvTarget2),
